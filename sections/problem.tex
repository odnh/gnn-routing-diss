...
\todo[inline]{fix to make the same as updated exponential version}
\begin{equation}
...
\EndFunction
\end{algorithmic}
\caption{DAG conversion algorithm retaining high path count from source to sink}
...
\todo[inline]{fix the definition of gravity sequence here, it is wrong... Reality is gravity and bimodal are forms of DM, bimodal vms vary and gravity does using sparsity. THese variations are used to build two types of sequence: average sequence and cyclical}
